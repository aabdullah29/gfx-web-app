...
import { useNotifiClientContext, useNotifiSubscriptionContext } from '@notifi-network/notifi-react-card'
  ...
  return (
    <div className="container">
      ...
      <NotifiSubscriptionCard
        ...
        cardId="8fc24f9d4e644ebea305c28f162998a5"
        ...
        copy={{
          FetchedStateCard: {
            SubscriptionCardV1: {
              ...
              EditCard: {
                AlertListPreview: {
                  description: 'Get your alerts here!!! you can subscribe to any of the following:'
                }
              }
            }
          }
