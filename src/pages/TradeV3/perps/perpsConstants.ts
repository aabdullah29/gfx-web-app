...
export const GET_LEADERBOARD_DATA = '/perps-apis/getLeaderboardDataV2'
export const GET_LATEST_CONTEST = '/perps-apis/getContestDetails'
export const GET_USER_RAFFLE_PRIZES = '/perps-apis/getUsersRafflePrizes'
